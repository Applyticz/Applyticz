...
possible_companies = [
    ...
    "Sony", "Nintendo", "Sega", "Capcom", "Bandai Namco", "Konami", "Square Enix", "Ubisoft", "Lucid", "Playstation", "SingleStore", "Disney", "Global Relay", "Sprout Social", "Wave", "Parsons", "Jamf", "Kikoff", "Twilio", "Citi Global", "Coalition", "Visa", "Konrad", "Meijer", "USAA"
]
